...
Three quantities tracked at each saved checkpoint:
...
Plotting all three on one axis shows when the symmetric kernel forms
relative to the empirical-loss cliff, whether the K-truncation is lossless
once K stabilizes, and how the gap L_empirical − L_symmetric (the
asymmetric-noise budget) evolves over training.
