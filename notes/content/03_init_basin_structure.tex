...
\begin{definition}[Good, bad, and Pareto-optimal initialization]
...
in~\cref{subsec:bgeo-cgap} below).  It is \emph{Pareto-optimal} if the
$\mathcal K$ it reaches lies on the cost-quality Pareto frontier of
bases.  It is \emph{bad} otherwise.
\end{definition}
...
\begin{enumerate}[leftmargin=*]
  ...
  \item The Pareto-optimal $\mathcal K$ identified in
