...
\item \textbf{CRT factorization sets a complexity floor.} Since $p-1 =
  ...
  The cheapest such pair has orders $(16, 7)$, giving an
...
\item \textbf{The basis-cost Pareto frontier maps the feasible algorithm
...
\item \textbf{Capacity pressure sharpens basin selection.} At
  ...
  exploration time among many viable bases. Architecturally,
...
\item Can architectural pressure or stratified curricula push observed
  ...
  pruning, capacity annealing, or curriculum may push closer.
